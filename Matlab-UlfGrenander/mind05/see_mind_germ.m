function see_mind_germ(content,connector,genre)
%displays current mind state as 2D graph

load 'C:\mind_data' G THEMES_NAME 
...
axis off
hold on
text(.4,1,['THOUGHT GERM'],'FontSize',20)
text(.4,.9,['GENRE: '],'FontSize',15,'Color','y')
text(.5,.9 ,[THEMES_NAME(1,genre)],'FontSize',15,'Color','y')
hold on
